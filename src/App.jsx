...
export default function App() {
  ...
  const handleLogout = () => {
    setState({ ...state, currentUser: null, isAdmin: false });
    setPage("home");
    ...
    <div className="app-container">
      ...
      <div className="content-wrapper">
        <div className="main-content">
          ...
          {page === "apply" && (
            <ApplyLoan state={state} setState={setState} showNotification={showNotification} />
          )}
          {page === "login" && (
            <Login state={state} setState={setState} setPage={setPage} showNotification={showNotification} />
          )}
          {page === "admin-login" && (
            <AdminLogin state={state} setState={setState} setPage={setPage} showNotification={showNotification} />
          )}
          {page === "admin-panel" && (
            <AdminPanel state={state} setState={setState} showNotification={showNotification} />
          )}
          {page === "dashboard" && (
            <Dashboard state={state} setState={setState} setPage={setPage} />
          )}
          {page === "repayment" && (
            <Repayment state={state} setState={setState} showNotification={showNotification} />
          )}
        </div>
        <Sidebar state={state} />
      </div>
